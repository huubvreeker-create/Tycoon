...
# TEMPORARY for testing — absurdly bumped so the player can buy
# anything at any tier without waiting. Revert to 5_000 once
# playtesting is done.
const STARTING_CASH: int = 1_000_000_000_000_000_000  # 1 quintillion (= 10^18)
